 ...
 * @author Ouda
 *
 * This class represents data key in the language record. Each key consists of:
 * a languageName and languageSize which determine the ordering with other data keys.
 */
